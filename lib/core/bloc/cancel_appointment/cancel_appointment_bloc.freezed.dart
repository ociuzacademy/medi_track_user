...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _CancellingAppointment value)?  cancellingAppointment,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _CancellingAppointment() when cancellingAppointment != null:
return cancellingAppointment(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _CancellingAppointment value)  cancellingAppointment,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case _CancellingAppointment():
return cancellingAppointment(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _CancellingAppointment value)?  cancellingAppointment,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _CancellingAppointment() when cancellingAppointment != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( CancelData cancelData)?  cancellingAppointment,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _CancellingAppointment() when cancellingAppointment != null:
return cancellingAppointment(_that.cancelData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( CancelData cancelData)  cancellingAppointment,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _CancellingAppointment():
return cancellingAppointment(_that.cancelData);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( CancelData cancelData)?  cancellingAppointment,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _CancellingAppointment() when cancellingAppointment != null:
return cancellingAppointment(_that.cancelData);case _:
...
class _CancellingAppointment implements CancelAppointmentEvent {
  const _CancellingAppointment({required this.cancelData});
  

 final  CancelData cancelData;

/// Create a copy of CancelAppointmentEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$CancellingAppointmentCopyWith<_CancellingAppointment> get copyWith => __$CancellingAppointmentCopyWithImpl<_CancellingAppointment>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CancellingAppointment&&(identical(other.cancelData, cancelData) || other.cancelData == cancelData));
}


@override
int get hashCode => Object.hash(runtimeType,cancelData);

@override
String toString() {
  return 'CancelAppointmentEvent.cancellingAppointment(cancelData: $cancelData)';
}
...
/// @nodoc
abstract mixin class _$CancellingAppointmentCopyWith<$Res> implements $CancelAppointmentEventCopyWith<$Res> {
  factory _$CancellingAppointmentCopyWith(_CancellingAppointment value, $Res Function(_CancellingAppointment) _then) = __$CancellingAppointmentCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class __$CancellingAppointmentCopyWithImpl<$Res>
    implements _$CancellingAppointmentCopyWith<$Res> {
  __$CancellingAppointmentCopyWithImpl(this._self, this._then);

  final _CancellingAppointment _self;
  final $Res Function(_CancellingAppointment) _then;

/// Create a copy of CancelAppointmentEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? cancelData = null,}) {
  return _then(_CancellingAppointment(
cancelData: null == cancelData ? _self.cancelData : cancelData // ignore: cast_nullable_to_non_nullable
as CancelData,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( AppointmentCancelResponseModel response)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CancelAppointmentInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( AppointmentCancelResponseModel response)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case CancelAppointmentInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( AppointmentCancelResponseModel response)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case CancelAppointmentInitial() when initial != null:
return initial();case CancelAppointmentLoading() when loading != null:
return loading();case CancelAppointmentSuccess() when success != null:
...
as AppointmentCancelResponseModel,
  ));
}
...
class CancelAppointmentError implements CancelAppointmentState {
  const CancelAppointmentError(this.error);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CancelAppointmentError&&(identical(other.error, error) || other.error == error));
}
