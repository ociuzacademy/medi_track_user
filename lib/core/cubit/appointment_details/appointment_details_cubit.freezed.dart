...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( AppointmentDetailsModel appointmentDetails)?  success,TResult Function( String errorMessage)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AppointmentDetailsInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( AppointmentDetailsModel appointmentDetails)  success,required TResult Function( String errorMessage)  error,}) {final _that = this;
switch (_that) {
case AppointmentDetailsInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( AppointmentDetailsModel appointmentDetails)?  success,TResult? Function( String errorMessage)?  error,}) {final _that = this;
switch (_that) {
case AppointmentDetailsInitial() when initial != null:
return initial();case AppointmentDetailsLoading() when loading != null:
return loading();case AppointmentDetailsSuccess() when success != null:
...
class AppointmentDetailsError implements AppointmentDetailsState {
  const AppointmentDetailsError(this.errorMessage);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppointmentDetailsError&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@override
String toString() {
  return 'AppointmentDetailsState.error(errorMessage: $errorMessage)';
}
