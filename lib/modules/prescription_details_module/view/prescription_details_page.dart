    ...
    return Scaffold(
      ...
      body: BlocBuilder<PrescriptionDetailsCubit, PrescriptionDetailsState>(
        builder: (context, state) {
          return switch (state) {
            PrescriptionDetailsLoading _ => const Center(
              child: CircularProgressIndicator(),
            ),
            PrescriptionDetailsError(:final message) => CustomErrorWidget(
              errorMessage: message,
              isDark: isDark,
              onRetry:
                  _prescriptionDetailsHelper.prescriptionDetailsInitializer,
            ),
            PrescriptionDetailsSuccess(:final data) => Stack(
              children: [
                // Main Content
                ...
                BottomActionButtons(prescriptionData: data),
              ],
            ),
