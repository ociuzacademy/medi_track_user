...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( AppointmentData appointmentData)?  bookingAppointment,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _BookingAppointment() when bookingAppointment != null:
return bookingAppointment(_that.appointmentData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( AppointmentData appointmentData)  bookingAppointment,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _BookingAppointment():
return bookingAppointment(_that.appointmentData);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( AppointmentData appointmentData)?  bookingAppointment,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _BookingAppointment() when bookingAppointment != null:
return bookingAppointment(_that.appointmentData);case _:
...
class _BookingAppointment implements AppointmentBookingEvent {
  const _BookingAppointment({required this.appointmentData});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BookingAppointment&&(identical(other.appointmentData, appointmentData) || other.appointmentData == appointmentData));
}
...
@override
String toString() {
  return 'AppointmentBookingEvent.bookingAppointment(appointmentData: $appointmentData)';
}
...
/// Create a copy of AppointmentBookingEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? appointmentData = null,}) {
  return _then(_BookingAppointment(
appointmentData: null == appointmentData ? _self.appointmentData : appointmentData // ignore: cast_nullable_to_non_nullable
as AppointmentData,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( AppointmentBookingResponseModel response)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AppointmentBookingInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( AppointmentBookingResponseModel response)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case AppointmentBookingInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( AppointmentBookingResponseModel response)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case AppointmentBookingInitial() when initial != null:
return initial();case AppointmentBookingLoading() when loading != null:
return loading();case AppointmentBookingSuccess() when success != null:
...
class AppointmentBookingSuccess implements AppointmentBookingState {
  const AppointmentBookingSuccess({required this.response});
...
@override
String toString() {
  return 'AppointmentBookingState.error(message: $message)';
}
